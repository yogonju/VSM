				...
				struct snd_pcm_hw_params *params)
{
	...
	unsigned int freq = params_rate(params) * 256;	//256/* 48K * 256 = 12.288 Mhz */
...
static struct snd_soc_dai_link wm8976_dai_link = {
	...
	.codec_dai_name = "wm8960_codec",		/* wm8976_dai's name */
	.codec_name 	= "wm8960.0-001a",		/* wm8976_i2c_driver name + '.' + bus + '-' + address(7bit) */
	.ops 			= &wm8976_ops,
	.symmetric_rates = 1,
...
static struct snd_soc_card wm8976_card = {
	.name 			= "I2S-WM8960",		/* proc/asound/cards */
	.owner 			= THIS_MODULE,
