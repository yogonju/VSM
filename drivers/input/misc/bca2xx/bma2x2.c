...
int xyz_g_table_bma250e[128] = {	//bma250e use it also
...
static void bma2x2_work_func(struct work_struct *work)
{
	...
	bma2x2_smbus_read_byte_block(bma2x2->bma2x2_client,BMA2X2_ACC_X10_LSB__REG, rdata, 6);

	s_x = ((rdata[0] >> 6) | (rdata[1] << 2));
	s_y = ((rdata[2] >> 6) | (rdata[3] << 2));
	s_z = ((rdata[4] >> 6) | (rdata[5] << 2));	

	x = 128 - (s_x >> 3); 	
	y = 128 - (s_y >> 3);
	z = 128 - (s_z >> 3);				

	//acc.x = xyz_g_table_bma250e[x];
	//acc.y = xyz_g_table_bma250e[y];
	acc.x = xyz_g_table_bma250e[y];
	acc.y = xyz_g_table_bma250e[x];
	acc.z = xyz_g_table_bma250e[z] / 2;
...
static DEVICE_ATTR(fifo_mode, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma2x2_fifo_mode_show, bma2x2_fifo_mode_store);
static DEVICE_ATTR(fifo_framecount, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma2x2_fifo_framecount_show, NULL);
static DEVICE_ATTR(fifo_trig, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma2x2_fifo_trig_show, bma2x2_fifo_trig_store);
static DEVICE_ATTR(fifo_trig_src, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma2x2_fifo_trig_src_show, bma2x2_fifo_trig_src_store);
static DEVICE_ATTR(fifo_data_sel, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
...
static DEVICE_ATTR(offset_x, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma2x2_offset_x_show,
		bma2x2_offset_x_store);
static DEVICE_ATTR(offset_y, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma2x2_offset_y_show,
		bma2x2_offset_y_store);
static DEVICE_ATTR(offset_z, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma2x2_offset_z_show,
		bma2x2_offset_z_store);
static DEVICE_ATTR(enable_int, 0664/*S_IWUSR|S_IWGRP|S_IWOTH*/,
...
static DEVICE_ATTR(slope_no_mot_duration, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma2x2_slope_no_mot_duration_show,
			bma2x2_slope_no_mot_duration_store);
static DEVICE_ATTR(slope_no_mot_threshold, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
...
static DEVICE_ATTR(softreset, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
